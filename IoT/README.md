...
* GPIO Pin Setup (Using BCM layout)
   * Keypad Pins (starting from the left)
      ...
      * Pin 7 - GPIO 20 
      * Pin 8 - GPIO 21 
<img src="keypadImage.png" width="200" height="40" alt="Keypad Image" style="float: left; margin-right: 10px;" />
   * LCD Screen Pins
      * GND - GND
      * VCC - 5V 
      * SDA - SDA1
   ...
   * Button Pins
      * RXD0
      * 3.3V
<img src="buttonImage.jpg" width="200" height="40" alt="Button Image" style="float: left; margin-right: 10px;" />
